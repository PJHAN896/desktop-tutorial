...
- "📹 카메라로 연습하기" 버튼을 누르면 답변하는 동안 얼굴이 화면에 나오고, 답변을 제출하면 방금 녹화한 영상을 바로 다시 볼 수 있습니다. 카메라는 완전히 선택 사항이라 버튼을 안 누르거나 권한을 거부해도 나머지 기능은 그대로 동작하며, 영상은 저장되지 않고 그 문항을 벗어나면 사라집니다.
